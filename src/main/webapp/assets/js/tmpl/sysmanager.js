...
departmentmanager:'<div id="permission_role" class=\"row\"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-heading">{{:#data}}</div>'+
 ...
 processlist:'<div class=\"row\"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-heading">流程实例列表</div>'+
	'<div class="panel-body"><div class="pull-right"><input id="displayName" type="text" placeholder="流程名称...">&nbsp;&nbsp;<button id="flow_query" type="button" class="btn btn-default">查询</button>&nbsp;&nbsp;'+
	'<button type="button" class="btn btn-success" id="flow_design">流程设计</button>&nbsp;&nbsp;<button id="flow_deploy" type="button" class="btn btn-success">流程部署</button></div>'+
 ...
 processedit:'<div class=\"row\"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-heading">流程修改</div>'+
    ...
    '<input type="hidden" name="id" value="{{:id}}" /></div><button type="submit" class="btn btn-success">上传文件</button></form>'+
 ...
 processdesigner:'<div class=\"row\"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-heading">流程实设计工具</div>'+
	'<div class="panel-body"><iframe src="../admin/flow/designer?processId={{:#data}}" scrolling="no" width="100%" height="750px" frameborder="no" border="0" marginwidth="0" marginheight="0"></div>',
 ...
 addpermission:'<div id="permission_role" class=\"row\"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-heading">{{:#data}}</div>'+
   '<div class="panel-body" ><div class="pull-right">'+
	'<button type="button" class="btn btn-success btn-sm" id="permission_create"><i class="fa fa-ok"></i> 确定</button>&nbsp;&nbsp;'+
	'<button type="button" class="btn btn-warning btn-sm" id="permission_cencal"><i class="fa fa-share-alt"></i> 取消</button></div><br/><br/>'+
 ...
 flowtoview: '<div id="flowtoview_process" class=\"row\"><div class="col-lg-12"><div class="panel panel-default"><div class="panel-heading">{{:title}}</div>'+
    '<div class="panel-body" ><div class="pull-right">'+
	'<button type="button" class="btn btn-warning btn-sm" id="permission_cencal"><i class="fa fa-share-alt"></i> 返回</button></div><br/><br/>'+
...
dicttable: '{{for content}}<tr><td>{{:category}}</td><td>{{:code}}</td><td>{{:name}}</td><td>{{:status}}</td><td>{{:parent}}</td>'+
