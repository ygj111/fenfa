...
@ComponentScan( basePackages ={"com.hhh.service","com.hhh.dao","com.hhh.fund.usercenter"}, 
					excludeFilters = @ComponentScan.Filter(value = Controller.class, type = FilterType.ANNOTATION)) 
@EnableJpaRepositories(basePackages = {"com.hhh.fund.usercenter.dao","com.hhh.dao"},
...
//	logger.info("Retrieve data source : " + dataSource.getConnection().createStatement());
		...
		lcemf.setPackagesToScan("com.hhh.dao.entity","com.hhh.fund.usercenter.entity");
